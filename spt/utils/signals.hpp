...
extern Gallant::Signal2<const char*, bool> DemoStartPlaybackSignal;
extern Gallant::Signal0<void> DemoStopPlaybackSignal;
extern Gallant::Signal3<bool, int, float> DemoUpdateSignal;
