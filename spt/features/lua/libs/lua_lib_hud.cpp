...
---@param maxX number
---@param maxY number
function hud.fill_rect(minX, minY, maxX, maxY)
end
...
---@param maxX number
---@param maxY number
function hud.outline_rect(minX, minY, maxX, maxY)
end
...
---@param endX number
---@param endY number
function hud.draw_line(startX, startY, endX, endY)
end
...
function hud.outline_circle(x, y, radius, segments)
end

---@param x number
---@param y number
---@param text string
function hud.draw_text(x, y, text)
end

---@param text string
---@return vec2
function hud.measure_text(text)
end
)""";
